...
SELECT cp.citation_type, COUNT(cc.penalty_id) AS "# of citations", 
COUNT(cc.penalty_id)*penalty_price AS "Total income from citations ($)"
FROM customer_citation cc
JOIN citation_penalty cp
USING(penalty_id)
GROUP BY 1
ORDER BY 2 DESC;
